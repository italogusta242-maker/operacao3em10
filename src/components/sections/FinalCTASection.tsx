    ...
    <section className="py-16 md:py-24 bg-gradient-to-b from-[hsl(122_50%_30%)] to-primary text-white" id="cta-final">
      <div ref={ref} className={`container max-w-4xl text-center ${isVisible ? "animate-fade-up" : "opacity-0"}`}>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {/* Option 1 */}
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-white/20 text-left">
          ...
          {/* Option 2 */}
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 md:p-8 border-2 border-white/40 text-left">
