  ...
  <section className="relative min-h-screen flex flex-col items-center justify-end md:justify-center px-5 pb-10 md:pb-0 overflow-hidden bg-background grain-overlay">
        ...
        >
          ...
          >
            <button
              ...
              className="bg-transparent border-2 border-accent text-accent font-display font-black text-xl py-3 px-8 rounded-full shadow-[0_0_20px_rgba(249,115,22,0.6),0_0_40px_rgba(249,115,22,0.3)] animate-pulse-cta cursor-pointer transition-all duration-300 hover:bg-accent/10"
            >
              Aceita o desafio?
            </button>
          </motion.div>
    ...
    <div className="relative z-10 flex flex-col items-center w-full max-w-3xl md:hidden">
      ...
      <motion.div
        ...
        className="text-left"
      >
        <h1 className="font-display font-black text-2xl sm:text-3xl leading-[1.15] tracking-tight text-foreground text-left">
          Elimine no mínimo 3kg de inchaço, destrave seu metabolismo e seque em{" "}
          <span className="text-gradient-primary text-glow-primary">10 dias</span> com a{" "}
          <span className="text-gradient-accent text-glow-accent">Operação -3kg em 10</span>.
        </h1>
        ...
        >
          <button
            onClick={() => document.getElementById("oferta")?.scrollIntoView({ behavior: "smooth" })}
            className="bg-transparent border-2 border-accent text-accent font-display font-black text-base py-3 px-8 rounded-full shadow-[0_0_20px_rgba(249,115,22,0.6),0_0_40px_rgba(249,115,22,0.3)] animate-pulse-cta cursor-pointer transition-all duration-300 hover:bg-accent/10"
          >
            Aceita o desafio?
          </button>
        </motion.div>
