...
const HeroSection = () => (
  <section className="relative min-h-[45vh] md:min-h-[75vh] flex flex-col items-center justify-center px-5 py-6 pb-16 md:py-10 md:pb-20 overflow-hidden bg-gradient-to-b from-[hsl(122_39%_94%)] to-background">
    {/* Logo */}
