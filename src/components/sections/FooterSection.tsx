  ...
  <footer className="py-12 md:py-16 bg-[hsl(0_0%_18%)] text-[hsl(0_0%_60%)]">
    <div className="container max-w-3xl">
      ...
      <div className="border-t border-[hsl(0_0%_25%)] pt-8 text-center space-y-2">
        <p className="text-xs">© 2026 Protocolo Reset 10D. Todos os direitos reservados.</p>
        <p className="text-xs">CNPJ: XX.XXX.XXX/0001-XX</p>
        <p className="text-xs">suporte@protocoloreset10d.com.br</p>
