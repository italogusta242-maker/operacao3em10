  ...
  return (
    <div className="flex flex-col h-full animate-fade-in w-full overflow-hidden">
      ...
      <div className="flex flex-col gap-2 flex-1 animate-fade-up animation-delay-600 overflow-y-auto pr-1 custom-scrollbar">
        ...
        {step.footerText && (
          <div className="mt-4 mb-6 text-center animate-fade-up animation-delay-800">
            <p className="text-base font-bold text-white/90 inline-flex items-center gap-2">
              <span className="text-xl">⚠️</span> {step.footerText.replace('⚠️ ', '')}
            </p>
          </div>
        )}
      </div>
