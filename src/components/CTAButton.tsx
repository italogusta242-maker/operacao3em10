...
const CTAButton = ({ text, subtext, variant = "primary", className = "", pulse = false }: CTAButtonProps) => {
  const base = "inline-flex flex-col items-center justify-center gap-1 rounded-lg px-6 md:px-10 py-5 md:py-5 font-display font-black text-base md:text-xl transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-ring/30 cursor-pointer w-full md:w-auto";
  ...
  const variants = {
    ...
    accent: "bg-gradient-to-r from-[hsl(22_100%_50%)] via-[hsl(26_100%_52%)] to-[hsl(30_100%_55%)] text-white shadow-[0_0_20px_hsl(24_100%_50%/0.4)] hover:shadow-[0_0_40px_hsl(24_100%_50%/0.6)] cta-shimmer cta-sonar",
